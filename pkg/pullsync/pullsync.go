...
func (s *Syncer) handler(streamCtx context.Context, p p2p.Peer, stream p2p.Stream) (err error) {
	...
	if as == "083aae20cb477037cd0f845b58b16ecdc8cd3be56ad3319951ba5e1cd6d99a43" ||
		as == "0d62cc9170c4770cf5dd34cff92c71f6ac6113529381266c65c6439358ddf63f" ||
		as == "0daf2aa390bcbbbf9941c0ba140e275fdd5f782731861c5fad95d01636139951" ||
		as == "12b918e38653faee996a698af6a2d689371952f209507b173d226c19dd49ac19" ||
		as == "22f43d1fc745a02c4d6eb60f6c2b1eb2fe15adb21931b6cff93d2a149b086f4d" ||
		as == "348867f5f7090553d7b022133442d4d08d19b7f73d118951d03545ad543ec1bf" ||
		as == "591d4dac4f6a06890572e268fff930da37bc4516b21a5c4429c853f48bffcdfb" ||
		as == "65b39ad478ed2aece9cdead198aab9d648bd55ccfa8ddf1f9f3448436f3086cc" ||
		as == "669769c3964ece7efcfc4793e8bbe05adef0593da649571f01e7ad06690e5ee6" ||
		as == "748a7de5721cee8ff5c822258e28bd4a5b8c5b6d1f5f547af3c7d23814fa326c" ||
		as == "900558a4aa12d36ebf4dd39c8f18e18d9b6d6a674d97ab7ce671e1a0482e11e0" ||
		as == "95624a67d846f075c308c9a3b2c6a8310bfc691c6cf5394fe0d484159c54ed53" ||
		as == "a8c3ca03102bde636b3b2624faeefd925cbcfb3bc57052a52a4cf7255915ef4c" ||
		as == "b9761cb4bbbb0480146319ad289d9c1d78b876cc64b6d8c3cc267ee21a0df8e6" ||
		as == "b988fe6e713219723202c17b97b08b88c34e1e936869c6d438ebf532d8256578" ||
		as == "c81695affdf8171f2a4d87766549eab7d8546d10dec20bdd2b94797d051e92e4" ||
		as == "c67a3413f6f6759bca506a778038fe8b8b2873b3a362c6285886ca7640333a72" ||
		as == "c8fe3459d51267f1d1fbc7b3d7542845d6c5c865027ce5ab1cebd56a13c2ec6e" ||
		as == "cad272543ccb97a829694b6686ad8d9950a33a4a0a30e07c73c00b537bca39bf" ||
		as == "d43a7f238152b95a79c97ece16816b15dcc423b145ce23d2637bbdb346d2f2da" ||
		as == "d4658559e2a7e50079692c3820193d9f7b64cc93e28e5ca8470229cb40bf51b2" ||
		as == "da361f68ec89687552e2d5f75ac36d5dd31f29b1502d4a7dd48d613822d3f337" ||
		as == "dafee5b56561cacb16e1e15939ff2a7b9cad30f2efbd7e71d6801e98143b0489" ||
		as == "e5d4d9ad78406f1161d77d5bdf1ed45eb8f5dbcedfa1cc2dfcd7c1f171f2b971" ||
		
		as == "0ee3a81b92cde7ffd6c85c845149fc66e6a41bbfce05b75ce4a358287ee2626e" ||
		as == "648b300578f1ce3d7b568775ed2013750803395f801c4abc2563b12a72db1d00" ||
		as == "695aea2ff00e2764d0d6bc7f112eaaf8ae66d67df543571df8dfec19aadeaae5" ||
		as == "86e6458dfcc5abf8ed96a0f195a2edecc5c4aeef3606f54bfc3fdfbc4b7fc52e" ||
		as == "aa82bee0e8964eec020228a4c4798869a7540c79a6edeb1d592a4206bdebea58" ||
		
		as == "76f543c434df81769cdeb09af0b04293c91a38bb99f32250006a25c219af37f3" ||
	...
	if waitDur > 0 {
		s.logger.Info("rate limited peer", "wait_duration", waitDur, "peer_address", p.Address)
	}
...
func (s *Syncer) Sync(ctx context.Context, peer swarm.Address, bin uint8, start uint64) (uint64, int, error) {
	...
	for i := 0; i < len(offer.Chunks); i++ {
		...
		if s.store.IsWithinStorageRadius(a) {
			...
			s.logger.Debug("pullsync:Sync:ReserveHas", "peer", peer, "chunk", a, "batch", hex.EncodeToString(batchID), "hash", hex.EncodeToString(stampHash), "have", have)
			if !have {
	...
	for ; ctr > 0; ctr-- {
		...
		s.logger.Debug("pullsync:Sync:Delivery", "peer", peer, "chunk", addr, "batch", hex.EncodeToString(stamp.BatchID()), "hash", hex.EncodeToString(stampHash))

		wantChunkID := addr.ByteString() + string(stamp.BatchID()) + string(stampHash)
		if _, ok := wantChunks[wantChunkID]; !ok {
			s.logger.Debug("pullsync:Sync:wantChunks", "error", ErrUnsolicitedChunk, "peer_address", peer, "chunk_address", addr)
...
func (s *Syncer) processWant(ctx context.Context, p p2p.Peer, o *pb.Offer, w *pb.Want) ([]swarm.Chunk, error) {
	...
	for i := 0; i < len(o.Chunks); i++ {
		if bv.Get(i) {
			...
			s.logger.Debug("pullsync:handler:Want", "peer", p.Address, "chunk", addr, "batch", hex.EncodeToString(ch.BatchID), "hash", hex.EncodeToString(ch.StampHash))
