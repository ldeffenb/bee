...
func (s *Service) CreatePin(ctx context.Context, ref swarm.Address, traverse bool) error {
	...
	iterFn := func(leaf swarm.Address) error {
		s.logger.Debug("pinTrace:CreatePin: pinned", "ref", ref.String(), "chunk", leaf.String())
	...
	s.logger.Debug("pinTrace:CreatePin: pinned", "ref", ref.String(), "traverse", traverse)
	key := rootPinKey(ref)
...
func (s *Service) DeletePin(ctx context.Context, ref swarm.Address) error {
	...
	iterFn := func(leaf swarm.Address) error {
		...
		s.logger.Debug("pinTrace:DeletePin: unpinning", "ref", ref.String(), "chunk", leaf.String())
	...
	if iterErr != nil {
		s.logger.Debug("pinTrace:DeletePin: ignoring ", "iterErr", iterErr)
		//return multierror.Append(ErrTraversal, iterErr)
	}

	s.logger.Debug("pinTrace:DeletePin: unpinned", "ref", ref.String())
	key := rootPinKey(ref)
